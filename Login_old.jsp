...
<table width="1002px" border="0" align="center" cellpadding="0"
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 0px;">
											...
											<tr>
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														<td class="forgottext">						<font color="red" size="2" ><b><%= msg %></b> </font></td>
													</tr>
													<tr>
														<td height="1" background="images/dotted-bg.jpg"></td>
													</tr>
	...
	</tr>	<tr ><td background="images/app-bg_bottom<%=theme %>.gif" style="background-repeat: repeat-x">&nbsp;</td></tr>
