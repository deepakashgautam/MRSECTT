...
<%
	...
	String valenc = request.getParameter("VALENC")!=null ? Encrypt.decrypt(request.getParameter("VALENC")):"";
	String val = request.getParameter("VAL")!=null ? request.getParameter("VAL"):"";
	val = valenc.equals("")? val : valenc;
...
%>
<fieldset><legend style="font-weight: bold;"><c:out value="<%=rval[r]%>"/></legend><table><tr><td>
