...
function bodyOnload(){
	...
	label2value();	
	setSessionSeachParams('SEARCHROLEIDFROM', '<%=sBean.getField1()%>');
	setSessionSeachParams('SEARCHROLEIDTO', '<%=sBean.getField2()%>');
	setSessionSeachParams('SEARCHROLENAME', '<%=sBean.getField3()%>');
	setSessionSeachParams('SEARCHDEPT', '<%=sBean.getField4()%>');
	setSessionSeachParams('SEARCHDEPT_DRP', '<%=sBean.getField4()%>');
	setSessionSeachParams('SEARCHAUTH', '<%=sBean.getField5()%>');
	setSessionSeachParams('SEARCHAUTH_DRP', '<%=sBean.getField5()%>');
	...
	<tr>
		...
		<table border="0"> 
				...
				<tr>
 				...
 				<tr>
					...
					%>
						<option value="<%=beanDeptCodE.getField1()%>"><%=beanDeptCodE.getField2()%></option>
					<%}%>
				</select>
			...
			<tr>
				<td align="left"  colspan="2">Auth Level
					...
					%>
						<option value="<%=beanAuthLevel.getField1()%>"><%=beanAuthLevel.getField2()%></option>
					<%}%>
				</select>
		...
		<table id="data" width="50%">
					...
					<tr class="trodd">
						...
						<input type="text" name="ROLEID" id="ROLEID" class="readonly" title="Auto Generated Field" value="<%=mstRoleBean.getROLEID()%>" onkeypress="chknumeric();" maxlength="4" readonly  >
						
						<%
						CommonBean beanCommon=(CommonBean) maxRoleId.get(0);
						%>
						<font color="green">Last Role ID : <%= beanCommon.getField1()%></font>
						</td>
					...
					<tr class="trodd">
						...
						<td nowrap="nowrap" valign="middle" width="302"><input
							...
							value="<%=mstRoleBean.getROLENAME()%>" size="20"></td>
					</tr>
					<tr class="trodd">
						...
						<td nowrap="nowrap" valign="middle" width="302"><input
							...
							value="<%=mstRoleBean.getFNAME()%>" size="20"></td>
			...
			<tr class="trodd">
				...
				<select name="DEPTCODE" id="DEPTCODE" style="width: 180px"  > 
					...
					<%
						...
						CommonBean beanDeptCodE=(CommonBean) deptCodeList.get(i);
					%>
						<option value="<%=beanDeptCodE.getField1()%>" <%=beanDeptCodE.getField1().equalsIgnoreCase(mstRoleBean.getDEPTCODE())?"selected":""%>><%=beanDeptCodE.getField2()%></option>
					<%}%>
				</select>
				</td>
			</tr>
			<tr class="trodd">
				...
				<select name="AUTHLEVEL" id="AUTHLEVEL" style="width: 180px"  >
					...
					<%
						...
						CommonBean beanAuthLevel=(CommonBean) authLevelList.get(i);
					%>
						<option value="<%=beanAuthLevel.getField1()%>" <%=beanAuthLevel.getField1().equalsIgnoreCase(mstRoleBean.getAUTHLEVEL())?"selected":""%>><%=beanAuthLevel.getField2()%></option>
					<%}%>
				</select>
				</td>
			</tr>
