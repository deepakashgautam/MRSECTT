...
<table width="100%" border="0" cellspacing="0" align="center">
	<tbody>
		<tr><td align="center"><b><font size="5"><b><c:out value='<%= sessionBean.getTENUREOFFICENAME()%>'/></b></font>
			<br><font size="3"><c:out value='<%= sessionBean.getTENUREOFFICEADDRESS()%>'/></font></td>
		</tr>
		<tr>
