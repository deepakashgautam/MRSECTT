...
function funconload() {
if('<%=formAction%>'=='GO'||'<%=formAction%>'=='SAVE'){
		...
		<tr>
			<td align="left" valign="middle" colspan="4"><nobr><b>Role Name :</b></nobr>&nbsp;&nbsp;&nbsp;<select name="txtGroupId" id="txtGroupId"
				...
				<option value="<%=beanCommon.getField1()%>"
					<%=beanCommon.getField1().equalsIgnoreCase(groupid)?"selected":""%>><%=beanCommon.getField2()%></option>
	...
	<td colspan="2" align="left" valign="top" >
			<table id="data" align="center">
				<tbody>
					...
					<tr>
						<td style="text-align: center" align="right" colspan="3"><u>File
						Sub. :</u></td>
					...
					<tr>
						<td align="right"><select
							ondblclick="fnMoveItems('FILESUBJECTCODE', 'SEL_FILESUBJECTCODE');"
							name="FILESUBJECTCODE" id="FILESUBJECTCODE"
							multiple="multiple" style="width: 180px; height: 100px">
							<%
							for(int k=0;k<fmsubjectList.size();k++){
							CommonBean beanCommon = (CommonBean) fmsubjectList.get(k);
						%>
							<option value="<%=beanCommon.getField1()%>"><%=beanCommon.getField2()%></option>
							<%}%>
						</select></td>
						<td valign="middle" align="center"><img align="middle"	src="images/next.gif"
							onclick="fnMoveAll( 'FILESUBJECTCODE','SEL_FILESUBJECTCODE')" /><br />
						<img align="middle" src="images/next_single.gif"
							onclick="fnMoveItems( 'FILESUBJECTCODE','SEL_FILESUBJECTCODE')" /><br />
						<img align="middle" src="images/prev_single.gif"
							onclick="fnMoveItems( 'SEL_FILESUBJECTCODE','FILESUBJECTCODE')" /><br />
						<img align="middle" src="images/prev.gif"
							onclick="fnMoveAll( 'SEL_FILESUBJECTCODE','FILESUBJECTCODE')" />
						</td>
						<td><select
							ondblclick="fnMoveItems('SEL_FILESUBJECTCODE', 'FILESUBJECTCODE');"
							name="SEL_FILESUBJECTCODE" id="SEL_FILESUBJECTCODE"
							multiple="multiple" style="width: 180px; height: 100px">
							<%
							for(int k=0;k<selfmsubjectList.size();k++){
							CommonBean beanCommon = (CommonBean) selfmsubjectList.get(k);
						%>
							<option value="<%=beanCommon.getField1()%>"><%=beanCommon.getField2()%></option>
							<%}%>
						</select></td>
