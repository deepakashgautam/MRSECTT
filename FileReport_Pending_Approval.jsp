...
<table width="100%" cellspacing="0" cellpadding="0" style="font-family: Tahoma; font-size: 10px;">
	<thead style="display: table-header-group;">
		<tr valign="top">
			...
			<td align="center" rowspan="2" style="border-bottom: dotted; border-top: dotted; border-width: 1px; border-color: gray;">Reg. No<br>Reg. Dt.</td>
...
<!-- 			Mark On</td> -->
		...
		<% if(bean.getField20().equalsIgnoreCase("C")){ %>
		   <td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><font color="red"><c:out value='<%=bean.getField2()%>'/>*</font><br><c:out value='<%=bean.getField3()%>'/>&nbsp;</td>
		<%}else{ %>
		   <td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><c:out value='<%=bean.getField2()%>'/><br><c:out value='<%=bean.getField3()%>'/>&nbsp;</td>
		<%} %>
		   ...
		   %>
		   	<nobr><c:out value='<%=bean2.getField1()%>'/>&nbsp;</nobr><%}%>&nbsp;</td>
...
<%-- 		<td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><%=bean.getField12()%>&nbsp;</td> --%>
<%-- 		<td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><%=bean.getField13()%><br><%=bean.getField14()%>&nbsp;</td> --%>
<%-- 		<td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><%=bean.getField15()%>&nbsp;</td> --%>
<%-- 		<td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><%=bean.getField16()%>&nbsp;</td> --%>
<%-- 		<td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><%=bean.getField17()%>&nbsp;</td> --%>
	...
	<%-- <td colspan="15" style="border-bottom: dotted; border-width: 1px; border-color: gray;"><%=bean.getField21()%>&nbsp;</td> --%></tr>
		<%} %>
</table>
<%} %>
</body>
