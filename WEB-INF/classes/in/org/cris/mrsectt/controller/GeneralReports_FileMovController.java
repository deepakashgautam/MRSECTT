...
public class GeneralReports_FileMovController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    int rNumber = 0;    
    
    public GeneralReports_FileMovController() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String referenceId ="";
		String referenceIdenc = Encrypt.decrypt(StringFormat.nullString(request.getParameter("referenceIdenc")));
		if (referenceIdenc.equals("")){
			referenceId = StringFormat.nullString(request.getParameter("referenceId"));
		} else {
			referenceId = referenceIdenc;
		}
