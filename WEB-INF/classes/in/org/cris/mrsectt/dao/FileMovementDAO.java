...
public class FileMovementDAO {
	
	
	static Logger log = LogManager.getLogger(FileMovementDAO.class);
	...
	public ArrayList<CommonBean> getFileMovement(String refno,String tenure) {
		...
		String strSQL =	" SELECT EOFFICERECIEPTNO, SEQNO, FROMID, TOID,FROMNAME,TO_CHAR(MOVEDATE,'DD/MM/YYYY hh24:mi') MOVEDATE,TOID,TONAME,FILENO " + 
			" FROM TRNREFMOVEMENT A WHERE EOFFICERECIEPTNO =(SELECT EOFFICERECEIPTNO FROM TRNREFERENCE WHERE REFNO=? and tenureid=?) " +
			/*" UNION "+
