...
public class TrnFileHdr {
	
  
	private String FMID	 = "";
	private String FMIDENC="";
	private String fmidencr ="";
	
	
	
	public String getFmidencr() {
		return fmidencr;
	}
	public void setFmidencr(String fmidencr) {
		this.fmidencr = fmidencr;
	}
	...
	private String ISBUDGETPOINT="";
	private String BUDGETPOINTVIPID="";
	private String BUDGETPOINTVIPPERSON="";
	
	
	
	public String getBUDGETPOINTVIPPERSON() {
		return BUDGETPOINTVIPPERSON;
	}
	public void setBUDGETPOINTVIPPERSON(String bUDGETPOINTVIPPERSON) {
		BUDGETPOINTVIPPERSON = bUDGETPOINTVIPPERSON;
	}
	public String getISBUDGETPOINT() {
		return ISBUDGETPOINT;
	}
	public void setISBUDGETPOINT(String iSBUDGETPOINT) {
		ISBUDGETPOINT = iSBUDGETPOINT;
	}
	public String getBUDGETPOINTVIPID() {
		return BUDGETPOINTVIPID;
	}
	public void setBUDGETPOINTVIPID(String bUDGETPOINTVIPID) {
		BUDGETPOINTVIPID = bUDGETPOINTVIPID;
	}
	...
	private String puclistenc = "";
	
	public String getPuclistenc() {
		return puclistenc;
	}
	public void setPuclistenc(String puclistenc) {
		this.puclistenc = puclistenc;
	}
