...
<%
    ...
    {
	dataArr = (new BudgetReportDAO()).getPeonReportData_InterimReply(sessionBean.getLOGINASROLEID(),sessionBean.getTENUREID(),BOOKDATEFROM,BOOKDATETO,CLASS,sessionBean.getISCONF()); 
	 System.out.println("size of array: "+dataArr.size());
	}
...
<body>
<form name="frm" action="PeonBookInterimReply.jsp" method="post">
<table>
<tr>  
      <td > 
      		<font size="3" > 
      			<b><i>Reference-Create</i> - Issue/Dispatch (Fair Letter Signed)</b>
				...
				<td align="center"><table width="984px" border="0"  cellspacing="0"
					...
					<tr>
						...
						<br><br><center><fieldset style="width: 60%;">		
								...
								<tbody><tr  align="center"><td  align="right"><b>Compliance Date:</b>&nbsp;</td>
						...
						<table width="80%" class="tablesorter" id="sorttable"
							...
							<thead>
								...
								<tr>
									...
									<table>
										<tr>
											<td nowrap="nowrap" style="text-align: left;" width="442"><HR>PEON BOOK FOR DT (Fair Letter Signed):<c:out value='<%=request.getParameter("BOOKDATEFROM")!=null ? request.getParameter("BOOKDATEFROM"):"" %>'/><br />
