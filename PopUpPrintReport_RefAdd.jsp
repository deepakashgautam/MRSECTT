...
String paramSTR3 = request.getParameter("param3") != null ? (String)request.getParameter("param3")+"" :"";
String paramSTR4 = request.getParameter("param4") != null ? (String)request.getParameter("param4")+"" :"";
...
<table width="100%">
	...
	<%if(paramSTR1.length()>0 && paramSTR2.length()>0){ %>
		<TD>
			<font size="2" face="Tahoma">Reference(s) received in Sectt., related to  <b><c:out value='<%=paramSTR3.toUpperCase() %>'/> <c:out value='<%=paramSTR4.toUpperCase() %>'/></b></font><br>
...
<script>
var x = window.opener.document.getElementById("searchResult").cloneNode(true);
