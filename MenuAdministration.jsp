		...
		<tr>
			...
			<td  align="left" valign="top" width="686"><select name="txtGroupId" id="txtGroupId" style="width: 110px">
					...
					<%
							...
							%>
					<option value="<c:out value='<%=beanCommon.getField1()%>'/>" <%=beanCommon.getField1().equalsIgnoreCase(groupid)?"selected":""%>><c:out value='<%= beanCommon.getField2()+" - "+beanCommon.getField3() %>'/></option>
...
myarray.remove(myarray.size()-1);%>
							...
							<li><a href="#"  
								ondblclick="addUrl('<c:out value="<%=bean.getMenuid() %>"/>','<c:out value="<%=bean.getFlag() %>"/>');"><c:out value="<%=bean.getMenutext() %>"/></a>
								<input type='hidden' name='menuid0' id='menuid0' value='<c:out value="<%=bean.getMenuid() %>"/>'/>
							<ul>
...
%>
								<li><a href="#"
									ondblclick="addUrl('<c:out value="<%=bean.getMenuid() %>"/>','<c:out value="<%=bean.getFlag() %>"/>');"><c:out value="<%=bean.getMenutext() %>"/></a>
									<input type='hidden' name='menuid0' id='menuid0' value='<c:out value="<%=bean.getMenuid() %>"/>'/></li>
...
myarray1.remove(myarray1.size()-1);%>
							...
							<li><a href="#"
								ondblclick="removeUrl('<c:out value="<%=bean1.getMenuid() %>"/>','<c:out value="<%=bean1.getFlag() %>"/>');"><c:out value="<%=bean1.getMenutext() %>"/></a>
								<input type='hidden' name='menuid1' id='menuid1' value='<c:out value="<%=bean1.getMenuid() %>"/>'/>
							<ul>
...
%>
								<li><a href="#"
									ondblclick="removeUrl('<c:out value="<%=bean1.getMenuid() %>"/>','<c:out value="<%=bean1.getFlag() %>"/>');"><c:out value="<%=bean1.getMenutext() %>"/></a>
									<input type='hidden' name='menuid1' id='menuid1' value='<c:out value="<%=bean1.getMenuid() %>"/>'/></li>
