...
<!-- <link type="text/css" href="${pageContext.request.contextPath}/theme/jquery/jquery-ui-1.7.1.custom.css" rel="stylesheet" /> -->
  ...
  <%
  	...
  	String queryRefClass = "SELECT REFCLASS, INOUT FROM MSTCLASS WHERE TENUREID = '"+sessionBean.getTENUREID()+"' and year=to_char(sysdate,'yyyy') order by rowid"; 
...
function openAttachment(REFID, ATTACHMENTID, ORIGFILENAME, NEWFILENAME,EOFFICEFLAG){
		var  prev_action = document.forms[0].action;
	//	var newimgid = assetid+"_"+imgid+ext;
		//alert(ORIGFILENAME+"-"+EOFFICEFLAG);
		window.document.forms[0].action="${pageContext.request.contextPath}/AttachmentController?ATTACHMENTID="+ATTACHMENTID+"&REFID="+REFID+"&ORIGFILENAME="+ORIGFILENAME+"&GENFILENAME="+NEWFILENAME+"&EOFFICEFLAG="+EOFFICEFLAG+"";
...
<option value="<c:out value='<%=beanCommon.getField1()%>'/>" <c:out value='<%=beanCommon.getField1().equalsIgnoreCase(refBean.getREFCLASS())?"selected":""%>'/><c:out value='<%=((request.getAttribute("refBean")==null)&&(request.getParameter("REFCLASS")!=null ?request.getParameter("REFCLASS"):"").equalsIgnoreCase(beanCommon.getField1()) ?"selected":"" ) %>'/>><c:out value='<%=beanCommon.getField1()%>'/></option>
						...
						<tr >
							...
							<td><select name="LANGUAGE" style="width: 120px" tabindex="3"  >
								...
								<%
										...
										%>
								<option value="<c:out value='<%=beanCommon.getField1()%>'/>" <c:out value='<%=beanCommon.getField1().equalsIgnoreCase(refBean.getLANGUAGE())?"selected":""%>'/><c:out value='<%=((request.getAttribute("refBean")==null)&&"1".equalsIgnoreCase(beanCommon.getField1()) ?"selected":"" ) %>'/>><c:out value='<%=beanCommon.getField2()%>'/></option>
								<%
									}%>
							</select></td>
							<%--   		    		
			    	...
			    	<table id="data" width="100%">	
			    		<tr >
			    			...
			    			<td nowrap="nowrap" width="75">Ref. Dated<span style="color: red"><b>*</b></span></td><td width="337"><input type="text" name="LETTERDATE" value="<c:out value='<%= refBean.getLETTERDATE()%>'/>"  onblur="chkWorkDate(this);" onkeypress="chknumeric(47);" maxlength="10" tabindex="6" size="14"></td>
					...
					<td>Party</td>
						...
						<td><input type="hidden" name="VIPID" value="<c:out value='<%=refBean.getADDVIPID() %>'/>"/></td>
						<td></td>
						<td><input type="hidden" name="VIPADDRESS" value="<c:out value='<%=refBean.getADDVIPTYPE() %>'/>"/>
						<input type="hidden" name="VIPSTATUSDESC" value="<c:out value='<%=refBean.getVIPSTATUSDESC() %>'/>"/>
						</td>
					</tr>
					...
					<tr  style="display: none">
						...
						<textarea rows="2" cols="70" name="SUBJECT" id="SUBJECT" 
											onkeypress="allowAlphaNum('()&/*');"></textarea> 
												<br>
						<span  style="display: none;">Stn1: <input type="text" name="keyword1" size="17"></span>
						<span  style="display: none;">Stn2: <input type="text" name="keyword2" size="17"></span>
						<span  style="display: none;">Trn: <input type="text" name="keyword3" size="17"></span>		
						<span style="display: none;"> <input type="text" name="k1" > <input type="text" name="k2" > <input type="text" name="k3" > </span>									
											</td>
						...
						<td nowrap="nowrap" colspan="2" width="165"><nobr><input type="text" name="TARGETDAYS" size="2" maxlength="2" value="7" onblur="setTargetDate('<c:out value='<%=serverDate %>'/>', this);" onkeypress="chknumeric();" />
					...
					TrnMarking markingBean = (TrnMarking)refBean.getMarkingBeanList().get(i);
						...
						<tr >
							<td nowrap="nowrap" width="442">
							<input type="hidden" name="MARKINGREFID" readonly="readonly" class="readonly" value="<c:out value='<%=markingBean.getREFID()%>'/>" size="5">
							<input type="hidden" name="MARKINGSEQUENCE" readonly="readonly" class="readonly" value="<c:out value='<%=markingBean.getMARKINGSEQUENCE()%>'/>" size="5">
							<input type="hidden" name="MARKINGRECEIPTNUMBER" readonly="readonly" class="readonly" value="<c:out value='<%=markingBean.getEOFFICERECEIPTNO()%>'/>" >
						...
						<%
							...
							<td nowrap="nowrap" colspan="2" width="165"><input type="text" name="TARGETDAYS" size="2" maxlength="2" value="<c:out value='<%= markingBean.getTARGETDAYS()%>'/>" onblur="setTargetDate('<c:out value='<%=serverDate %>'/>', this);" onkeypress="chknumeric(47);" >
							<input type="text" class="readonly" size="10" maxlength="10" readonly name="TARGETDATE" value="<c:out value='<%= markingBean.getTARGETDATE()%>'/>"></td></tr>
				...
				<table width="100%" id="data">
					<tr >
						...
						<br>
							<textarea onkeypress="allowAlphaNum('()/*');" rows="2" cols="70"
								name="REMARKS" tabindex="20"><c:out value='<%= refBean.getREMARKS()%>'/></textarea></td><td nowrap="nowrap" width="95">Signed By</td>
			    		<td width="216">
					...
					<td nowrap="nowrap"  width="517">Tour/Parliament Remarks 
						<br>
							<textarea onkeypress="allowAlphaNum('()/*');" rows="2" cols="70"
								name="TOURREMARKS" tabindex="20"><c:out value='<%= refBean.getTOURREMARKS()%>'/></textarea></td>
				...
				<table width="100%" id="data">
					...
					<td nowrap="nowrap" width="120">Compliance</td>
			    		<td width="216">
							<select name="COMPLIANCE" style="width: 120px" tabindex="21"> 	 
						...
						<br>
							<textarea onkeypress="allowAlphaNum('()/*');" rows="2" cols="70"
								name="COMPREMARKS" tabindex="20"><c:out value='<%= refBean.getCOMPLIANCEREMARKS()%>'/></textarea></td>
				...
				<tr  id="TAGS" style="display: none" style="display: none">
							<td>Zone</td>
							<td><input type="text" name="TAG1" value="<c:out value='<%= refBean.getTAG1()%>'/>" tabindex="28" size="20" maxlength="20" onkeypress="allowAlphaNum('()&/*');"></td>
							<td>Division</td>
							<td><input type="text" name="TAG2" value="<c:out value='<%= refBean.getTAG2()%>'/>" tabindex="29" size="20" maxlength="20" onkeypress="allowAlphaNum('()&/*');"></td>
							<td>Station</td>
							<td><input type="text" name="TAG3" value="<c:out value='<%= refBean.getTAG3()%>'/>" tabindex="30" size="20" maxlength="20" onkeypress="allowAlphaNum('()&/*');"></td>
							<td>Train</td>
							<td><input type="text" name="TAG4" value="<c:out value='<%= refBean.getTAG4()%>'/>" tabindex="31" size="20" maxlength="20" onkeypress="allowAlphaNum('()&/*');"></td>
						</tr>
				
				<tr  id="ODS" style="display: none">
					<td>Place-1</td>
					<td><input type="text" name="ODSPLACE" value="<c:out value='<%= refBean.getODSPLACE()%>'/>" tabindex="25" onkeypress="allowAlphaNum('()&/*');"></td>
					
					<td>Place-1</td>
						<td><input type="text" name="ODSRAILWAY" value="<c:out value='<%= refBean.getODSRAILWAY()%>'/>" tabindex="26" onkeypress="allowAlphaNum('()&/*');"></td>
						<td>Date</td>
						<td><input type="text" name="ODSDATE" value="<c:out value='<%= refBean.getODSDATE()%>'/>" onblur="chkWorkDate(this);" onkeypress="chknumeric(47);" maxlength="10" tabindex="27"></td>
							<td></td>
							<td></td>
						</tr>
				...
				%>
					...
					<td nowrap="nowrap"><textarea rows="2" cols="30" name="BDGSUBJECT" onkeypress="return MaxLength(this, 399);allowAlphaNum('()/');"><c:out value='<%= budgetBn.getSUBJECT()%>'/></textarea></td>
					<td nowrap="nowrap"><textarea rows="2" cols="30" name="BDGMRREMARK" onkeypress="return MaxLength(this, 399);allowAlphaNum('()/');"><c:out value='<%= budgetBn.getMRREMARK()%>'/></textarea></td>
					<td nowrap="nowrap"><textarea rows="2" cols="30" name="BDGREMARK" onkeypress="return MaxLength(this, 399);allowAlphaNum('()/');"><c:out value='<%= budgetBn.getREMARK()%>'/></textarea></td>
					<td nowrap="nowrap">
			...
			<div style="width: 100%;height:350px;overflow: scroll;overflow-x:hidden;background-color: white; "><c:out value='<%=refBean.getREPLY() %>'/></div>
					...
					<tr >
						<td align="left" width="100%" colspan="4">&nbsp;
							...
							<%} %>	
						    	...
						    	%>
								<tr>
									<td width="507" align="left"><a href="#" onclick="openAttachment('<c:out value="<%=cmnbn.getField1()%>"/>','<c:out value="<%=cmnbn.getField2()%>"/>','<c:out value="<%=cmnbn.getField3()%>"/>','<c:out value="<%=cmnbn.getField4()%>"/>','<c:out value="<%=cmnbn.getField5()%>"/>');"><font color="blue"><c:out value="<%=cmnbn.getField3()%>"/></font></a></td>
									<td align="center">
				...
				<tr class="trodd">
					<td colspan="6">
						<%if(request.getAttribute("refBean")!=null){ %>
						<input class="butts" type="button" name="attachbutt" value="Add pdf/jpg" style= "width: 100px" onclick="addrow(window.document.getElementById('attachimg'));">(Upload .JPG or .PDF files only.)
						<%} %>
