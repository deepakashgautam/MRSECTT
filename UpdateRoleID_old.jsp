...
%>
		<TR class="<%=i%2==0?"treven":"trodd" %>" align="left" >
			...
			<td><input type="text" name="OROLEID" id="OROLEID"  value="<%=beanCommon.getField1() %>" maxlength="4" readonly size="10" ></td>
			<td><input type="text" name="OROLENAME" id="OROLENAME" maxlength="50" value="<%=beanCommon.getField2() %>" size="30" readonly>
				<INPUT type="hidden" name="dtlid" value="<%=bean.getField1()%>"></td>
