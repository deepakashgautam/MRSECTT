...
{ 
  ...
  this.nodeImg = 0;
  this.isLastNode = 0;
  this.iconSrc = ICONPATH + "tms.images/ftv2folderopen.gif";
  this.iconSrcClosed = ICONPATH + "tms.images/ftv2folderclosed.gif";
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "tms.images/ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "tms.images/ftv2lastnode.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "tms.images/ftv2mlastnode.gif"  
      else
        srcStr = ICONPATH + "tms.images/ftv2plastnode.gif"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "tms.images/ftv2node.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "tms.images/ftv2mnode.gif"
      else
        srcStr = ICONPATH + "tms.images/ftv2pnode.gif"
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + "tms.images/ftv2doc.gif" 
  //itemArray.iconSrc=0
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "tms.images/ftv2lastnode.gif' width=16 height=22></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "tms.images/ftv2vertline.gif><img src='" + ICONPATH + "tms.images/ftv2node.gif' width=16 height=22></td>"
    } 
  ...
  if (USEICONS)
	  ...
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "tms.images/ftv2blank.gif height=2 width=3>"
...
function blockStartHTML(idprefix) {
  ...
  docW = docW + "<table style='margin-top: 0px;' border=0 cellspacing=0 cellpadding=0 width=100% >"
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "tms.images/ftv2vertline.gif><img src='" + ICONPATH + "tms.images/ftv2vertline.gif' width=16 height=22></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "tms.images/ftv2blank.gif' width=16 height=22></td>"
		}
	}
	return retStr
}
...
function preLoadIcons() {
	var auxImg
	auxImg = new Image();
	auxImg.src = ICONPATH + "tms.images/ftv2vertline.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2mlastnode.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2mnode.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2plastnode.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2pnode.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2blank.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2lastnode.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2node.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2folderclosed.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2folderopen.gif";
	auxImg.src = ICONPATH + "tms.images/ftv2doc.gif";
}
