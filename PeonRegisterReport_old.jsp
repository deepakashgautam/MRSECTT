						...
						<table width="100%" align="center">
							<thead>
								...
								<tr>
									...
									<table width="100%">
										<tr>
											<td nowrap="nowrap" style="text-align: left;" width="442"><hr />Peon    Book for Date : <%=request.getParameter("BOOKDATEFROM")!=null ? request.getParameter("BOOKDATEFROM"):"" %> - <%=request.getParameter("BOOKDATETO")!=null ? request.getParameter("BOOKDATETO"):"" %><br/>Ref. Class : <%=request.getParameter("CLASS").length()>0 ? request.getParameter("CLASS"): "ALL" %><hr/></td>
