						...
						<TR>
							...
							<table width="100%" id="data">
								<tbody>
									...
									<input type="hidden" name="reportNumber" size="15"><FONT size="3">Statistical-Forward To (Target Dt.)</font></th>
									</tr>
						<tr>
...
%>
								...
								<td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;"><c:out value='<%= clrdCaseTotal %>'/></TD>
