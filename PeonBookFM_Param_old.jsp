						...
						<table width="30%" align="center" style="border: solid; border-width: 1.5"><tr><td>
							<table id="data">
								<tbody>
									...
									<td align="left" width="497" valign="top"><input type="text" name="datefrom" id="datefrom" value="<%= date.get(0).getField1() %>" size="11"> to
									<input type="text" name="dateto" id="dateto" value="<%= date.get(0).getField1() %>" size="11"></td>
									</tr>
								</tbody>
							</table>
							</td></tr>
