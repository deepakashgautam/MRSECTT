...
<script>
 ...
 function openReport(repid,param,reptype){
 	...
 	window.location.href="Report"+reptype+".jsp?reportidencr="+repid+"&"+param;
 }
 
 function runReport(repid,repType){
 	window.location.href="GenerateReportController?save=Y&generate=Y&reportidencr="+repid+"&repTypeenc="+repType;
 }
                    ...
                    <td align="center" style="padding-left:7px;">
                     <table  width="40%" border="1" bordercolor="#7e7d7d" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                  	...
                  	<tr>
                  		...
                  		<td><c:out value="<%=  URLDecoder.decode(reparr.get(i).getField()[1])   %>"/></td>
