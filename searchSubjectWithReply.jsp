 ...
 // alert(searchStringid.className.replace("ac_input","").Trim());  
  ...
  var htmlText = '';
	...
	counter++;
		...
		var attachmentfile = (trnRefBean.ISATTACHMENTFILE == "1"? '<img border="0" alt="Image Gallery" src="${pageContext.request.contextPath}/images/stn.gif" onclick="popupGallery(\''+trnRefBean.fmidenc+'\',\''+trnRefBean.fmidenc+'\',2);">': "");
...
function dataSearchDetail2(data){
 ...
 // var srno;
	...
	for(var loop=0,srno=0; loop < data.length; loop++){
		...
		var attachment = (trnRefBean.ISATTACHMENT == "1"? '<img border="0" alt="Image Gallery" src="${pageContext.request.contextPath}/images/stn.gif" onclick="popupGallery(\''+trnRefBean.FMIDENC+'\',\''+trnRefBean.FMIDENC+'\',2);">': "");
