						...
						<td colspan="9"><br><br><center><fieldset style="width: 60%;">
								...
								<tr align="center">
									...
									<td nowrap="nowrap"><input type="text" name="FREFNO" id="FREFNO" size="10" onkeyup="setToField(this, 'TREFNO');"
										value="<c:out value='<%= request.getParameter("FREFNO")!=null ? request.getParameter("FREFNO"):""%>'/>" /></td>
									<td></td>
									<td nowrap="nowrap"><input type="text" name="TREFNO" id="TREFNO" size="10"
										value="<c:out value='<%=request.getParameter("TREFNO")!=null ? request.getParameter("TREFNO"):""%>'/>" /></td>
									<td align="right"></td>
									<td nowrap="nowrap"></td>
						</tr>
						...
						<table width="100%" align="center">
							<thead>
								...
								<tr>
									...
									<table width="100%">
										<tr>
											<td nowrap="nowrap" style="text-align: left;" width="442"><hr />Peon    Book for Date : <c:out value='<%=request.getParameter("BOOKDATEFROM")!=null ? request.getParameter("BOOKDATEFROM"):"" %>'/> - <c:out value='<%=request.getParameter("BOOKDATETO")!=null ? request.getParameter("BOOKDATETO"):"" %>'/><br/>
																											Reference No. : <c:out value='<%=request.getParameter("FREFNO")!=null ? request.getParameter("FREFNO").toUpperCase():"" %>'/> - <c:out value='<%=request.getParameter("TREFNO")!=null ? request.getParameter("TREFNO").toUpperCase():"" %>'/><hr/></td>
