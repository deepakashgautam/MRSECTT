...
function bodyOnLoad(){
	showDiv();
	label2value();	
	setSessionSeachParams('sSUBJECTCODE', '<%=sBean.getField1()%>');
	setSessionSeachParams('sSUBJECTNAME', '<%=sBean.getField2()%>');
	setSessionSeachParams('sSUBJECTDEPT', '<%=sBean.getField3()%>');
 	getSearch();
 		...
 		<td colspan="2">Department : <select name="department" id="department" style="width: 200px; height: 20px;">
			<%
				for(int j=0;j< arrDeptList.size();j++) {
					...
					<option value="<%=cbn.getField1()%>" <%=cbn.getField1().equalsIgnoreCase(departmentCode)?"selected":""%>><%= cbn.getField2() %></option>
			 <%}%>
...
%>
		...
		<TD><%= i+1 %></TD>
			<TD><INPUT type="hidden" name="dtlid" value="<%=bean.getField1()%>">
				<input class="readonly"	type="text" name="RSUBCODE" id="RSUBCODE" value="<%=beanCommon.getField1() %>" maxlength="3" size="10" readonly  ></TD>
			<td><input type="text" name="RSUBNAME" id="RSUBNAME" id="RSUBNAME" maxlength="30" value="<%=beanCommon.getField2() %>" size="30" readonly  ></td>
			...
			<td><input type="hidden" name="RISNEW" id="RISNEW" value="N" size="5">
				...
				<input type="hidden" name="RSUBTYPE" id="RSUBTYPE" size="5" value="<%=beanCommon.getField4() %>">
...
%>
		<TR class="<%=i%2==0?"treven":"trodd" %>" align="left" >
			<TD><INPUT type="hidden" name="dtlid" value="<%=bean.getField1()%>">
				<input class="readonly"	type="text" name="FSUBCODE" value="<%=beanCommon.getField1() %>" maxlength="3" size="10" readonly></TD>
			<td><input type="text" name="FSUBNAME" id="FSUBNAME" maxlength="30" value="<%=beanCommon.getField2() %>" size="30" readonly></td>
			...
			<td><input type="hidden" name="FISNEW" id="FISNEW" value="N" size="5">
				...
				<input type="hidden" name="FSUBTYPE" id="FSUBTYPE" size="5" value="<%=beanCommon.getField4() %>">
				<INPUT type="hidden" name="dtlid" value="<%=bean.getField1()%>">
