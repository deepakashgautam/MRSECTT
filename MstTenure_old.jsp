...
function bodyOnLoad(){
	showDiv();
	label2value();	
	setSessionSeachParams('sTENUREID', '<%=sBean.getField1()%>');
	setSessionSeachParams('sNAME', '<%=sBean.getField2()%>');
	setSessionSeachParams('sYEAR', '<%=sBean.getField3()%>');
 	getSearch();
		...
		<table border="0" width="170">
			...
			<tr>
					...
					<tr>
					 ...
					 <tr>
						<td align="right" width="130"><img width="20" height="20" src="images/printer_new.png" onclick="window.open('PopUpPrintReport.jsp?flag=y');" title="Print"></img></td>
					</tr>
		...
		<fieldset>
			<table width="100%" id="data">
					<tr class="trodd">
						...
						%>
						<td  valign="middle" width="186"><input type="text" class="readonly" title="Auto Generated Field" name="TENUREID" id="TENUREID" value="<%=mstTenureBean.getTENUREID() %>" readonly  ><font color="green">Last ID : <%=beanCmn.getField1()%></font></td>
						...
						<td width="478"><select name="ROLEID" id="ROLEID" style="height: 25px;"  >
							...
							%>
							<option value="<%=beanCommon.getField1()%>" <%=beanCommon.getField1().equalsIgnoreCase(mstTenureBean.getROLEID())?"selected":""%>><%=beanCommon.getField2()%></option>
							<%
							}%>
						</select></td>
					...
					<tr class="trodd">
						<td nowrap height="31" valign="middle" width="117">Tenure Start Date<font
							color="red">*</font> :</td>
						<td height="31" valign="middle" width="186"><input type="text" name="TENURESTARTDATE" id="TENURESTARTDATE" maxlength="10" value="<%= mstTenureBean.getTENURESTARTDATE() != null? mstTenureBean.getTENURESTARTDATE():"" %>" size="20"  ></td>
						<td height="31" width="159">Tenure End Date :</td>
						<td height="31" width="478"><input type="text" name="TENUREENDDATE" id="TENUREENDDATE" maxlength="10" value="<%= mstTenureBean.getTENUREENDDATE() != null? mstTenureBean.getTENUREENDDATE():"" %>" size="20"  ></td>
					</tr>
					<tr class="trodd">
						<td nowrap height="31" valign="middle" width="117">Name<font
							color="red">*</font> :</td><td height="31" valign="middle" width="186"><input type="text" name="NAME" id="NAME" maxlength="50" value="<%=mstTenureBean.getNAME() %>" size="30"  ></td>
						
						<td nowrap height="31" valign="middle" width="159">Year<font
							color="red">*</font> :</td><td height="31" valign="middle" width="478">
						<input type="text" name="YEAR" id="YEAR" class="readonly" maxlength="20" value="<%=mstTenureBean.getYEAR() %>" size="20" readonly  ></td>
						
					</tr>
					<tr class="trodd">
						<td nowrap height="31" valign="middle" width="117">Tenure Office Name<font
							color="red">*</font> :</td><td height="31" valign="middle" width="186"><input type="text" name="TENUREOFFICENAME" id="TENUREOFFICENAME" maxlength="40" value="<%=mstTenureBean.getTENUREOFFICENAME() %>" size="40"  ></td>
						
						<td nowrap height="31" valign="top" width="159">Tenure Office Address :</td><td height="31" valign="middle" width="478"><input type="text" name="TENUREOFFICEADDRESS" id="TENUREOFFICEADDRESS" size="80" value="<%= mstTenureBean.getTENUREOFFICEADDRESS() != null? mstTenureBean.getTENUREOFFICEADDRESS():"" %>" maxlength="100"  ></td>
...
%>
			<TR class="<%=i%2==0?"trodd":"trodd" %>" align="center" >
				<TD><INPUT type="hidden" name="dtlid" value="<%=bean.getField1()%>">
					<INPUT type="text" name="REFCLASS" id="REFCLASS" value="<%=bean.getField1()%>" size="8" style="text-align: left; text-transform: uppercase"" maxlength="3"  ></TD>
...
<option value="O" <%="O".equalsIgnoreCase(bean.getField2())?"selected":""%>>O</option>
							...
							<td><%=bean.getField3()%><input type="hidden" name="ISNEW" id="ISNEW" value="N" size="5"></td>
							<TD><INPUT type="hidden" name="dtlid" value="<%=bean.getField1()%>">
					<INPUT type="text" name="CLASSDESCRIPTION" id="CLASSDESCRIPTION" value="<%=bean.getField4()%>" size="40" style="text-align: left; text-transform: uppercase"" maxlength="50"  ></TD>
			</TR>
<%
	}
%>
