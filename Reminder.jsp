...
function popupReminder(obj)
{
	...
	if(chkblank(document.frm.FREMDATE) && chkblank(document.frm.TREMDATE) && chkblank(document.frm.SIGNEDBY)){
		var url=""; 
		if(repno==2){
		url="ReminderReportNew.jsp?FREMDATE="+FREMDATE+"&TREMDATE="+TREMDATE+"&CLASS="+CLASS+"&DEPT="+DEPT+"&STATE="+STATE+"&REMARKS="+REMARKS+"&DREMARKS="+DREMARKS+"&SUBJECT="+SUBJECT+"&SIGNEDBY="+SIGNEDBY+"&REQOF="+REQOF;
		}else if(repno==3){
