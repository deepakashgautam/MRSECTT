	...
	if(aa == 'false'){
		...
		if(flag)
		{
			if(chkblank(window.document.getElementById("refclass"))){
				...
				window.document.frm.action="StaticReportsDetailedController";
...
<form name="frm" id="frm" action="StaticReportsDetailedController" method="post">
<table>
<tr>  
      <td > 
      		<font size="3" > 
      			<b><i>Reference-Create</i> - Report-Statistical Detailed</b>
				...
				<center><fieldset  style="width: 70%"><table width="70%" id="data">
								<tbody>
									...
									<input type="text" name="diarynoto" value="MR/A/5/2012" size="15" onkeypress="changecase(this,'U');" onkeyup="changecase(this,'U');"> (e.g. MR/A/1/1900)</td>
									</tr>
						<tr id="tr2"  style="display: none;">
									...
									<td align="left" ><input type="text" name="datefrom" id="datefrom" value="<%=sessionBean.getTENURESTARTDATE() %>" size="11"/> to
		...
		<select name="statecode" id="statecode" style="width: 160px" tabindex="10">
							...
							%>
								<option value="<%=beanCommon.getField1()%>"><%=beanCommon.getField2()%>
								</option>
							<%}%>
		</select></td>
						</tr>
