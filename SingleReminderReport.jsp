				...
				<td><table width="100%" border="0"  cellspacing="0" cellpadding="0" style="border-collapse: collapse; margin-top: 1px;">
					<tr>
						...
						<table width="80%" class="tablesorter" id="sorttable" align="center" style="margin-left: 60px">
							...
							<tr align="center">
									<td colspan="5"><FONT size="3"><b><c:out value='<%= sessionBean.getTENUREOFFICENAME() %>'/></b></FONT></td>
								</tr>
								<tr align="center">
								...
								<tr align="center">
									...
									<br />
									&nbsp;<font><u><b><c:out value='<%= REMARKS %>'/></b></u></font></td>
								</tr>
								<tr>
									<td colspan="5">
									<p style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Given below are the details of the case sent by this office bearing target date <c:out value='<%= rb.getTARGETDATE() %>'/>, which is pending.</p>
							...
							<tbody id="content">
								...
								<tr  >
									...
									No. :</td>
									<td style="vertical-align: top" class="bototmDashed" width="794"><c:out value='<%= rb.getREFNO() %>'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value='<%= rb.getINCOMINGDATE() %>'/> <br /> &nbsp;(&nbsp;Ref. Dated: <c:out value='<%= rb.getLETTERDATE() %>'/>&nbsp;)
									</td>
								</tr>
								<tr  >
									<td style="vertical-align: top" class="bototmDashed" width="198">Received From :</td>
									<td style="vertical-align: top" class="bototmDashed" width="794"><c:out value='<%= rb.getREFERENCENAME() %>'/>,&nbsp;&nbsp;<c:out value='<%= rb.getVIPSTATUS() %>'/>,&nbsp;&nbsp;<c:out value='<%= rb.getSTATECODE() %>'/> </td>
								</tr>
								<tr  >
									<td style="vertical-align: top" class="bototmDashed" width="198">Subject :</td>
									<td style="vertical-align: top" class="bototmDashed" width="794"><c:out value='<%= rb.getSUBJECT() %>'/></td>
								</tr>
								<tr  >
...
<%} %>&nbsp;
					...
					<tr>
						...
						<td style="vertical-align: top" class="bototmDashed" width="910"><c:out value='<%=reminderBean.getREMINDERTYPE() %>'/></td>
						<td style="vertical-align: top" class="bototmDashed" width="800"><c:out value='<%=reminderBean.getREMINDERDATE() %>'/></td>
						<td style="vertical-align: top" class="bototmDashed" width="910"><c:out value='<%=reminderBean.getREMINDERREMARK() %>'/></td>
						<td style="vertical-align: top" class="bototmDashed" width="910"><c:out value='<%=reminderBean.getSIGNEDBY() %>'/></td>
						<td style="vertical-align: top" class="bototmDashed" width="800"><c:out value='<%=reminderBean.getSIGNEDON() %>'/></td>
					</tr>
					<%} %>
							</tbody>
						</table> <%} %><br><br><br><br>
						<table align="center" width="80%" style="margin-left: 60px">
										<tr>
											...
											<td colspan="1" align="right" width="26"><b><c:out value='<%=SignedByName%>'/></b><br /><c:out value='<%=serverDate %>'/>
											</td>
											<td colspan="1" align="right" width="46"></td>
										</tr>
							<tr>
								<td align="left"><b><u><c:out value='<%= rb.getMARKINGTO() %>'/></u></b></td>
						...
						<table width="100%" class="tablesorter" id="sorttable" align="center" >
							<thead>
								...
								<tr align="center">
									<td colspan="5" style="height: 5px;" align="right"><br />
									<br />
									<font><c:out value='<%= REMARKS %>'/></font></td>
								</tr>
								<tr>
									<td colspan="5">
									<p style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;
									Given below are the details of case sent by this office dealt with File No : <c:out value='<%= rb.getFILENO() %>'/>.</p>
							...
							<tbody id="content">
								...
								<tr>
									...
									<td style="vertical-align: top" class="bototmDashed" width="1085">: <c:out value='<%= rb.getFILENO() %>'/></td>
								</tr>
								<tr  >
									<td style="vertical-align: top" class="bototmDashed" width="116">Diary
									No</td>
									<td style="vertical-align: top" class="bototmDashed" width="1085">:&nbsp;<c:out value='<%= rb.getREFNO() %>'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value='<%= rb.getINCOMINGDATE() %>'/><br /> &nbsp;&nbsp;(&nbsp;Ref. Dated: <c:out value='<%= rb.getLETTERDATE() %>'/>&nbsp;)</td>
								</tr>
								<tr  >
									<td style="vertical-align: top" class="bototmDashed" width="116">Ref.
									From</td>
									<td style="vertical-align: top" class="bototmDashed" width="1085">:&nbsp;<c:out value='<%= rb.getREFERENCENAME() %>'/>,&nbsp;&nbsp;<c:out value='<%= rb.getVIPSTATUS() %>'/>,&nbsp;&nbsp;<c:out value='<%= rb.getSTATECODE() %>'/> </td>
								</tr>
								<tr  >
									<td style="vertical-align: top" class="bototmDashed" width="116">Contents</td>
									<td style="vertical-align: top" class="bototmDashed" width="1085">:&nbsp;<c:out value='<%= rb.getSUBJECT() %>'/></td>
								</tr>
								<tr  >
								...
								<tr>
									...
									<td style="vertical-align: top" class="bototmDashed" width="1085">: <c:out value='<%= rb.getFILESTATUS1()%>'/></td>
								</tr>
								<tr>
									<td style="vertical-align: top" class="bototmDashed" width="116"><b></b>File Status 2</td>
									<td style="vertical-align: top" class="bototmDashed" width="1085">: <c:out value='<%= rb.getFILESTATUS2()%>'/></td>
								</tr>
					...
					<br><br><br><br>
						<table align="center" width="80%">
										<tr>
											<td colspan="1" align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td colspan="2" width="720"></td>
											<td colspan="1" align="left" width="26"><b><c:out value='<%=SignedByName%>'/></b><br /><c:out value='<%=serverDate %>'/>
											</td>
											<td colspan="1" align="right" width="46"></td>
										</tr>
							<tr>
