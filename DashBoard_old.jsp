...
if(pfdate==''){
vfdate='<%=sessionBean.getTENURESTARTDATE()%>';
}else{
vfdate=pfdate;
}
if(ptdate==''){
...
case "1":
 ...
 DashboardDAO.getTotalReference('<%=sessionBean.getTENUREID()%>',vcond,
...
case "4":
//alert(chartid);
 DashboardDAO.getSSEWiseConsumption("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
...
case "5":
//alert('hiiiii');
 DashboardDAO.getStateWiseConsumption("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
  	function (data) {
  	//alert(data.length);
...
case 6:
case "6":
 DashboardDAO.getSSWiseConsumption("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
...
case "11":
//alert('11');
	DashboardDAO.getSSbillingD("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
...
case 12:
case "12":
DashboardDAO.getSEBWiseConsumptionBilling("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
...
case "14":
//alert(chartid);
 DashboardDAO.getSSEWiseConsumptionBilling("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
...
case 15:
case "15":
 DashboardDAO.getStateWiseConsumptionBilling("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
...
case 16:
case "16":
 DashboardDAO.getMonthWiseConsumption("<%=authlevel%>","<%if(authlevel.equalsIgnoreCase("6")){%>"+vrlycode+"<%}else if(authlevel.equalsIgnoreCase("5")){%>"+vdivcode+"<%}else{%>"+vroleid+"<%}%>",vcond,vcategory,vrlycode,vdivcode,
...
generatePieChart('','<%=sessionBean.getTENURESTARTDATE()%>','<%=serverDate%>');
...
//alert(vs1[0]);
    ...
    ptintedPlot = $.jqplot(divid, [s1, s2, s3], {
      //  title: 'Monthly Consumption of '+'<%=designation%>'+' for Last Three Years',
        animate: true,
      ...
      cursor:{ 
        ...
        series:[
            {label:'<%=Integer.parseInt(currDate)%>'},
            {label:'<%=Integer.parseInt(currDate)-1%>'},
            {label:'<%=Integer.parseInt(currDate)-2%>'}
        ],
        seriesColors: seriesColors,
...
<div id="dashboardid">
	  <div id="sortableHDR">
		...
		<input type="text" size="15" name="fdate" id="fdate"  value="<%=sessionBean.getTENURESTARTDATE() %>" onblur="chkWorkDate(this);" onkeypress="chknumeric(47);" maxlength="10" tabindex="5" class="ui-datepicker-calendar">
		<input type="text" size="15" name="tdate" id="tdate"  value="<%=serverDate%>" onblur="chkWorkDate(this);" onkeypress="chknumeric(47);" maxlength="10" tabindex="5">
