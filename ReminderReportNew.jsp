...
<link type="text/css" href="/MRSECTT/theme/jquery/jquery-ui-1.7.1.custom.css" rel="stylesheet" />
...
<%
	...
	String vvip=request.getParameter("vvip")!=null ? request.getParameter("vvip") : "";
	...
	String SignedByName = (new CommonDAO()).getStringParam(SignedBy);
		...
		tmpCond += vvip.length() > 0? "AND B.ADDVIPTYPE in ('CM','GOV','MIN','PM')":"";
        ...
        <tr>
				...
				<td><table width="100%" border="0"  cellspacing="0"
					...
					<tr>
						...
						<div id="reportData" align="left" style="vertical-align: top;">
						<table width="100%"  align="center" >
							
								<tr align="center">
									<td colspan="5"><FONT size="4"><b><c:out value='<%= sessionBean.getTENUREOFFICENAME() %>'/></b></FONT></td>
								</tr>
								
								<tr align="center">
									<td colspan="5"><FONT size="2"><c:out value='<%= sessionBean.getTENUREOFFICEADDRESS() %>'/></FONT></td>
								</tr>
								<tr align="center">
									<td colspan="5" style="height: 5px;" align="right"><br />
									<br />
									&nbsp;<font><b><u><c:out value='<%= REMARKS %>'/></u></b></font></td>
								</tr>
								
								<tr>
									<td colspan="5">
									<p style="text-align: justify; font-size: 15px; font: Tahoma;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Given
									below is a list of case(s) sent by this office and reply to which still pending.</p>

									<p style="text-align: justify; font-size: 15px; font: Tahoma;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									Receipts can be viewed & downloaded, if required, from mrsectt.cris.org.in/EISECTT. Sharing of portal ID & password of respective deptts including portal related training has already been provided to the nominated staff of all the concerned deptts. It is requested to please expedite submission of file(s) with consolidated draft reply as from Hon'ble MR immediately (within five days) for kind perusal of Hon’ble MR.</p>
								</td>
								</tr>
								<tr>
									<td colspan="5"><br /><br />
									<table align="center" width="100%">
										<tr>
											<td colspan="3"> <b><u><c:out value='<%=cb.getField2() %>'/></u></b></td>
											<td colspan="2" align="right"><b><c:out value='<%=SignedByName%>'/></b><br /><c:out value='<%=serverDate %>'/>
											</td>
										</tr>
									</table>
									</td>
							...
							<thead  style="display: table-header-group;">	
								<tr>
									...
									<td class="bototmDashedth"><b><nobr>E-Office No.</nobr>&nbsp;&nbsp;</b></td>
									<td class="bototmDashedth"><b><nobr>Sent To</nobr>&nbsp;&nbsp;</b></td>
									<td class="bototmDashedth"><b><nobr>Sent On</nobr>&nbsp;&nbsp;</b></td>
									<td class="bototmDashedth"><b><nobr>Currently With</nobr>&nbsp;&nbsp;</b></td>
									</tr>
							</thead>
							<tbody id="content" >
								<%   ArrayList<TrnReminder> dataArr = new ArrayList<TrnReminder>();
    								 dataArr =  (new ReminderAutoDAO()).getReminderReportData(sessionBean.getLOGINASROLEID(),sessionBean.getTENUREID(),FREMDATE,TREMDATE,CLASS,cb.getField1(),STATE,REQOF,ISCONF,SUBJECT,DREMARKS,vvip);
									...
									<td style="vertical-align: top;page-break-inside:avoid;page-break-after: auto;" class="bototmDashed"><c:out value='<%=rb.getREFNO() %>'/><b>&nbsp;&nbsp;</b><br><c:out value='<%=rb.getINCOMINGDATE() %>'/><b>&nbsp;&nbsp;</b></td>
									<td style="vertical-align: top;page-break-inside:avoid;page-break-after: auto;" class="bototmDashed"><c:out value='<%=rb.getREFERENCENAME() %>'/>,<c:out value='<%=rb.getVIPSTATUS() %>'/>,<c:out value='<%=rb.getSTATECODE() %>'/><b>&nbsp;&nbsp;</b><br/>[<c:out value='<%=rb.getSUBJECT() %>'/>]<b>&nbsp;&nbsp;</b></td>
									<td style="vertical-align: top;page-break-inside:avoid;page-break-after: auto;" class="bototmDashed"><c:out value='<%=rb.getTARGETDATE() %>'/>&nbsp;&nbsp;
									<br /><br />Reply burst by <c:out value='<%= rb.getTARDAYS() %>'/> day(s)
									</td>
									<td style="vertical-align: top;page-break-inside:avoid;page-break-after: auto;" class="bototmDashed"><c:out value='<%=rb.getEOFFICEREFNO() %>'/><b>&nbsp;&nbsp;</b></td>
									<td style="vertical-align: top;page-break-inside:avoid;page-break-after: auto;" class="bototmDashed"><c:out value='<%=rb.getREMINDERTO() %>'/><b>&nbsp;&nbsp;</b></td>
									<td style="vertical-align: top;page-break-inside:avoid;page-break-after: auto;" class="bototmDashed"><c:out value='<%=rb.getMARKINGDATE() %>'/><b>&nbsp;&nbsp;</b></td>
									<td style="vertical-align: top;page-break-inside:avoid;page-break-after: auto;" class="bototmDashed"><c:out value='<%=rb.getREFCURRENTLYWITH() %>'/><b>&nbsp;&nbsp;</b></td>
									</tr>
								<%}%>
