...
function bodyOnload(){
	...
	label2value();	
	setSessionSeachParams('sDEPTCODE', '<c:out value="<%=sBean.getField1()%>"/>');
	setSessionSeachParams('sDEPTNAME', '<c:out value="<%=sBean.getField2()%>"/>');
	...
	<tr>
		...
		<table id="data" width="50%">
					...
					<tr class="trodd">
						...
						<input type="text" name="DEPTCODE" id="DEPTCODE" class="readonly" title="Auto Generated Field" value="<c:out value='<%=mstDepartmentBean.getDEPTCODE()%>'/>" maxlength="4" readonly >
						
						<%
						CommonBean beanCommon=(CommonBean) maxDepartmentId.get(0);
						%>
						<font color="green">Last Department Code : <c:out value='<%= beanCommon.getField1()%>'/></font>
						</td>
					...
					<tr class="trodd">
						...
						<td nowrap="nowrap" valign="middle" width="386"><input type="text" name="DEPTNAME" id="DEPTNAME" maxlength="400"
							value="<c:out value='<%=mstDepartmentBean.getDEPTNAME()%>'/>" size="50">
