					...
					<tr>
						...
						<table width="100%"  align="center" >
								...
								<tr>
									...
									below is a list of case(s) sent by this office, which are
									pending.</p>

									<p style="text-align: justify; font-size: 15px; font: Tahoma;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									You are requested to expedite the action and furnish the consolidated current 
status of all the case(s) immediately for the kind perusal of Hon’ble MR.</p>
								</td>
								</tr>
								<tr>
									<td colspan="5"><br /><br />
