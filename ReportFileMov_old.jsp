...
function resetdiv() {
//alert("in reset div");
	divval= new Array("0" <% for(int i=0;i<DESTMARKING.length;i++){%>,"<%= DESTMARKING[i] %>"<%} %>);
		...
		<table width="984" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="tablehead">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<th class="tableheadtext" height="20">Custom Report Parameter <%= repheader.length()>0?" { "+repheader+" }":"" %></th>
										</table></td>
									</tr>
									<tr>
										<td>
                  ...
                  <tr class="firstbg">
                  		<th colspan="8" height="20"> Filter Criteria<input type="hidden" name="dummyfield" value="" /><input type="hidden" name="repType" value="2" /></th>
														...
														<table width="100%" border="0" style="width: 939px;">
															<tbody align="left">
																<tr class="trodd">
																	...
																	value="<%= REGDATEFROM!=""?REGDATEFROM:sessionBean.getTENURESTARTDATE()%>"/>
																	&nbsp;<input type="text" name="REGDATETO" id="REGDATETO"
																		size="10" value="<%= REGDATETO!=""?REGDATETO:serverDate%>"/></td>
													...
													%>
														<option value="<%= beanCommon.getField1()%>" <%=beanCommon.getField1().equalsIgnoreCase(MARKTOUP)?"selected":""%>><%= beanCommon.getField2()%></option>
													<%}%>
																	</select></td>
																</tr>
																<tr class="trodd">
																	...
																	<td colspan="3" width="345"><input type="text"
																		name="MARKINGREMARKS" id="MARKINGREMARKS" size="34" value="<%= MARKINGREMARKS %>"/></td>
																</tr>
																<tr class="treven">
				...
				<%
					...
					CommonBean beanCommon=(CommonBean) markToUpwardList.get(i);
				%>
<option value="<%= beanCommon.getField1()%>" <%=beanCommon.getField1().equalsIgnoreCase(INTMARKING)?"selected":""%>><%= beanCommon.getField2()%></option>
																		<%}%>
																	</select></td>
																	...
																	<td colspan="3" width="345"><select
																		...
																		id="INTMARKINGFROM" size="10" value="<%= INTMARKINGFROM %>"/>
																	&nbsp;<input type="text" name="INTMARKINGTO" size="10"
																		style="display: none;" id="INTMARKINGTO" value="<%= INTMARKINGTO %>"/></td>
																</tr>
																<tr class="trodd">
																	...
																	<td width="345" colspan="3"><input type="text"
																		name="MARKINGREMARKS1" id="MARKINGREMARKS1" size="34" value="<%= MARKINGREMARKS1 %>"/></td>
																</tr>
																<tr class="treven">
					...
					CommonBean beanCommon=(CommonBean) markToUpwardList.get(i);
				%>
<option value="<%= beanCommon.getField1()%>" <%=beanCommon.getField1().equalsIgnoreCase(MARKTODOWN)?"selected":""%>><%= beanCommon.getField2()%></option>
																		<%}%>
																	</select></td>
																...
																<tr class="trodd">
																	...
																	<select	name="REPLYTYPE" id="REPLYTYPE">
																		...
																		%>
																			<option value="<%=beanCommon.getField1()%>"	<%=beanCommon.getField1().equalsIgnoreCase(REPLYTYPE)?"selected":""%>><%=beanCommon.getField2()%></option>
																		<%}%>
																	</select></td>
																</tr>
																<tr class="treven">
																	...
																	<td width="300"><input type="text" name="REASON"
																		id="REASON" size="34" value="<%= REASON %>"/></td>
																	<td width="164"></td>
																	<td width="345" colspan="3"></td>
																</tr>
															</tbody>
														</table>
														</th>
...
<option value="21">Pendency(No. of Days)</option>            
                 ...
                 <br />
                  ...
                  <table border="1" bordercolor="#7e7d7d" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border: solid 1px #7e7d7d;">
                  	<tr class="treven">
              			<td>   Report  Title</td><td> <input type="text" name="repheader" id="repheader" value="<%= repheader %>" size="100" /></td>
              		</tr>
