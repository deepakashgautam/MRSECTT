...
<div id="reminderDiv"><table border="0">
							...
							<td nowrap="nowrap" align="left"><select style="width: 120px;height: 50px" multiple="multiple"" name="DEPT" id="DEPT" tabindex="2">
								...
								<%
										...
										<tr align="center">
											<td align="left">Target From&nbsp;: &nbsp;</td><td nowrap="nowrap" align="left"><input type="text" name="FREMDATE" id="FREMDATE" tabindex="5" value='<%=request.getParameter("FREMDATE")!=null ? request.getParameter("FREMDATE"):sessionBean.getTENURESTARTDATE()%>' size="25"/> </td>
											<td nowrap="nowrap" align="left">&nbsp; &nbsp;</td>

											<td align="left">Target To  :&nbsp; &nbsp;</td><td nowrap="nowrap" align="left"><input type="text" name="TREMDATE" id="TREMDATE" value='<%=request.getParameter("TREMDATE")!=null ? request.getParameter("TREMDATE"):serverDate%>' size="25" tabindex="6" /> </td>
			...
			<input type="text" name="SUBJECT" id="SUBJECT"
				...
				<tr align="center">
											...
											<td nowrap="nowrap" colspan="4" align="left"><input
												...
												value='<%=request.getParameter("DREMARKS")!=null ? request.getParameter("DREMARKS"):""%>'
												size="75" tabindex="7" /></td>
										</tr>
		<tr align="center">
										...
										%>
											...
											<td> <input type="radio" name="vvip" id="vvip" value='<%=request.getParameter("vvip")!=null ? request.getParameter("vvip"):"1"%>' > yes </td>
...
<div id="reminderDivSingle"><table border="0">
		...
		<tr align="center">
											...
											<td nowrap="nowrap" colspan="4" align="left"><input tabindex="4"
												...
												value='<%=request.getParameter("REMARKSINGLE")!=null ? request.getParameter("REMARKSINGLE"):""%>'
												size="55" />
											<input type="hidden" name="buttonClick" id="buttonClick" value='<%=request.getParameter("buttonClick")!=null ? request.getParameter("buttonClick"):""%>' />
										</td>
										</tr>
		<tr align="center">
