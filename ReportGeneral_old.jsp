      ...
      <td > 
			...
			<td align="left" height="18" colspan="11">&nbsp;</td>
						...
						<tr id="a1" class="treven">
							...
							<input type="hidden" name="ISCONF" id="ISCONF" value="<%= sessionBean.getISCONF() %>">
							<input type="hidden" name="ROLEID" id="ROLEID" value="<%= sessionBean.getLOGINASROLEID() %>"></td>
			...
			<td align="left" height="18" colspan="11">&nbsp;</td>
				...
				<center><fieldset style="width: 60%; text-align: center"><table width="70%" id="data" align="center">
								<tbody>
									...
									<input type="text" name="diarynoto"  size="15" > <span id="normal" style="display:none" >(e.g. A/1)</span><span id="Ackonly" style="display:none">(e.g. A/1/2016)</span></td>
									</tr>
