...
ArrayList<CommonBean> RefDashBoardDetails = new DashboardSubjectWiseDAO().getRefDashBoardDetailListHODSubHead(subjectCode,loginName,status);
...
function SaveCompliance(refno,sno,loginIDName){
	...
	DashboardSubjectWiseDAO.saveComplianceDataSub(refno,compliance,compliianceRem,loginIDName,dateSaveCompliance);
...
<br>
 <input type="hidden" name="loginID" value="<%=loginName%>">
  <input type="hidden" name="subjectCode" value="<%=subjectCode%>">
   ...
   <input type ="hidden" value ="subHOD" name ="typeOfUser">		
