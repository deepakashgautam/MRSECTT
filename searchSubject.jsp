...
if(chkblank(document.frm.FDATE) && chkblank(document.frm.TDATE)) {
 ...
 // alert(searchStringid.className.replace("ac_input","").Trim());  
  ...
  // alert(searchString);
	...
	if('<c:out value = "<%=type%>"/>'=='RO'){
	TrnReferenceDAO.getSearchSub(searchString,fdate,tdate,sphrase,roleID,ISCONF,ISREPLY,advstxt,refClass,dataSearchDetail);
	}
	if('<c:out value = "<%=type%>"/>'=='RF'){
	TrnReferenceDAO.getSearchSub1(searchString,fdate,tdate,sphrase,roleID,dataSearchDetail1);
	}
	if('<c:out value = "<%=type%>"/>'=='FO'){
	TrnFileManagementDAO.getSearchSub2(searchString,fdate,tdate,sphrase,roleID,ISCONF,ISREPLY,advstxt,dataSearchDetail2);
	}
	if('<c:out value = "<%=type%>"/>'=='FF'){
  ...
  var htmlText = '';
	...
	htmlText = '<table class="tablesorter" id="sorttable" width="100%" style="page-break-after: always;display: table-header-group;">';	
	htmlText += '<thead style="display: table-header-group;"><tr><th filter="false"  style="border: solid 1px black;border-style: dotted">S.No.</th><th filter="false" style="border: solid 1px black;border-style: dotted"></th><th  style="border: solid 1px black;border-style: dotted"><b>Ref.No.</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Incoming Date</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Ref.Dated</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Letter No</b></th><th  style="border: solid 1px black;border-style: dotted;"><b>Received From</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Status</b></th><th  style="border: solid 1px black;border-style: dotted"><b>State</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Party</b></th><th nowrap="nowrap" style="border: solid 1px black;border-style: dotted;"><b>Sub.</b></th><th nowrap="nowrap" style="border: solid 1px black;border-style: dotted;width:200px;"><b>Subject</b></th><th align="center" nowrap="nowrap"  style="border: solid 1px black;border-style: dotted"><b>Forward To</b></th><th align="center" nowrap="nowrap"  style="border: solid 1px black;border-style: dotted"><b>Ack. By</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Remarks</b></th><th  style="border: solid 1px black;border-style: dotted"><b>E-Office Reference No</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Tour/Parliament Remarks</b></th><th  style="border: solid 1px black;border-style: dotted"><b>File No.</b></th><th  style="border: solid 1px black;border-style: dotted"><b>FM Mark To</b></th><th  style="border: solid 1px black;border-style: dotted"><b>FM Mark On</b></th><th  style="border: solid 1px black;border-style: dotted"><b>File Status1</b></th><th  style="border: solid 1px black;border-style: dotted"><b>File Status2</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Return To</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Return On</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Compliance</b></th><th  style="border: solid 1px black;border-style: dotted;width:200px;"><b>Compliance Remarks</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Compliance Date</b></th></tr></thead>';
	...
	counter++;
		...
		var attachment = "";
		var attachment = (trnRefBean.ISATTACHMENT == "1"? '<img border="0" alt="Image Gallery" src="${pageContext.request.contextPath}/images/stn.gif" onclick="popupGallery(\''+trnRefBean.refidencr+'\',\''+trnRefBean.refidencr+'\',1);">': "");
		 /* if((trnRefBean.ISATTACHMENT == "1")){
			//attachment = ('<img border="0" alt="Image Gallery" src="${pageContext.request.contextPath}/images/stn.gif" onclick="popupGallery();">');
			//alert(attachment);
		}  */
		var attachment1 ="";
		attachment1=(trnRefBean.ISATTACHMENTFILE == "1"? '<img border="0" alt="Image Gallery" src="${pageContext.request.contextPath}/images/stn.gif" onclick="popupGallery(\''+trnRefBean.fmidenc+'\',\''+trnRefBean.fmidenc+'\',2);">': "");
		...
		htmlText +='<tr><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+ counter +'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+ attachment +'&nbsp'+ attachment1 +'&nbsp;</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+REFNO+'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.INCOMINGDATE+'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.LETTERDATE +'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+(trnRefBean.LETTERNO != null? trnRefBean.LETTERNO: "") +'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.REFERENCENAME+'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.VIPSTATUS+'&nbsp;</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.STATECODE+'&nbsp;</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.VIPPARTY+'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.SUBJECTCODE + (trnRefBean.ISBUDGET == "Y"?" - Budget":"") +'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;width:200px;">'+trnRefBean.SUBJECT+'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.MARKINGTO+'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+(trnRefBean.ACKBY != null? (trnRefBean.ACKBY+"  "+trnRefBean.ACKDATE): "")+'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.REMARKS + (trnRefBean.SIGNEDBY != null? (trnRefBean.SIGNEDBY+"  "+trnRefBean.SIGNEDON): "") +'&nbsp;&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.EOFFICEREFNO+'&nbsp;</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.TOURREMARKS+'</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;"><a href="#" onclick="PopUpFile(\''+trnRefBean.refidencr+'\');">'+trnRefBean.FILENO+'</a>&nbsp;</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.IMARKINGTO+'&nbsp;</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.IMARKINGON+'&nbsp;</td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.FILESTATUS1+'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.FILESTATUS2+'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.DMARKINGTO+'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.DMARKINGDATE+'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.COMPLIANCE+'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.COMPLIANCEREMARKS+'&nbsp;</td><td style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+trnRefBean.COMPLIANCEDATE+'&nbsp;</td></tr>';
...
function dataSearchDetail2(data){
 ...
 // var srno;
	htmlText = '<table class="tablesorter" id="sorttable" width="100%" style="page-break-after: always; display: table-header-group;">';	
	htmlText += '<thead style="display: table-header-group;"><tr><th filter="false"  style="border: solid 1px black;border-style: dotted">S.No.</th><th filter="false" style="border: solid 1px black;border-style: dotted"></th><th  style="border: solid 1px black;border-style: dotted"><b>Reg.No<br>Reg.Dt.</b></th><th  style="border: solid 1px black;border-style: dotted"><b>File Type</b></th><th  style="border: solid 1px black;border-style: dotted"><b>File No.</b></th><th  style="border: solid 1px black;border-style: dotted;"><b>Branch<br>Final Marking</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Received From</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Subject</b></th><th nowrap="nowrap" style="border: solid 1px black;border-style: dotted;" ><b>Marking To</th><th align="center" nowrap="nowrap"  style="border: solid 1px black;border-style: dotted"><b>File Status1<br>File Status2</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Full Status</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Mark To<br>Mark On</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Remarks</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Reply type</b></th><th  style="border: solid 1px black;border-style: dotted"><b>Reason</b></th><th  style="border: solid 1px black;border-style: dotted"><b>E-Office File Number</b></th><th  style="border: solid 1px black;border-style: dotted"><b>SentTo (Fair Letter Signed)</b></th></tr></thead>';
	htmlText += '<tbody  id="content">';
	var refBean = new Array(data.length);
	...
	for(var loop=0,srno=0; loop < data.length; loop++){
		...
		var attachment = (trnRefBean.ISATTACHMENT == "1"? '<img border="0" alt="Image Gallery" src="${pageContext.request.contextPath}/images/stn.gif" onclick="popupGallery(\''+data[loop].fmidencr+'\',\''+data[loop].fmidencr+'\',2);">': "");
 		//alert(attachment);
		if(data[loop].COUNT==1){
		htmlText += '<tr><td align="center" id="std00" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+srno+' </td><td  style="border-bottom: dotted; border-width: 1px; border-color: gray;">'+ attachment +'&nbsp;</td> <td align="center" id="std0" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+REGISTRATIONNO+'<br>'+data[loop].REGISTRATIONDATE+' </td><td  id="std1" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].REFERENCETYPE+' </td><td  id="std2" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].FILENO+'<br><a href="#" onclick="PopUpRef(\''+data[loop].puclistenc+'\');">'+data[loop].PUCLIST+'</a> </td><td  id="std3" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].DEPARTMENTCODE+'<br>'+data[loop].DESTINATIONMARKING+' </td><td id="std31"   style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].RECEIVEDFROM+' </td><td  id="std4" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].SUBJECT+'&nbsp; </td><td  id="std5" valign="top" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" align="left" colspan="1" valign="top"> <nobr>'+data[loop].IMARKINGTO+'</nobr>&nbsp; </td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"><nobr>'+data[loop].FILESTATUS1+'</nobr><br><nobr>'+data[loop].FILESTATUS2+'</nobr></td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].REMARKS+'</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].DMARKINGTO+'<br>'+data[loop].DMARKINGDATE+'</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].MARKINGREMARK+'</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].REPLYTYPE+'</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].REASON+'</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].EOFFICEFILENO+'</td> <td  id="std9" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" valign="top"> '+data[loop].SENTTO+'</td></tr>';
		}
		
	}	
	htmlText += '<tr><td align="center" id="std00" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td> <td align="center" id="std0" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std1" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma;;">&nbsp;</td><td  id="std2" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std3" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td id="std31"   style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std4" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std5" valign="top" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 10px;" align="left" colspan="1">&nbsp;</td><td  id="std6" valign="top" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" align="left" colspan="1">&nbsp;</td><td  id="std7" valign="top" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;" align="left" colspan="1">&nbsp;</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td><td  id="std8" style="border-top: dotted; border-width: 1px; border-color: gray; font-family: Tahoma; font-size: 11px;">&nbsp;</td> </tr>';
	htmlText += '</tbody></table>';
	reportData.innerHTML = htmlText;
	if(sphrase=="0"){
  	highlightSearchTerms(searchString,false);
...
{
	 //alert(val);
	var url="PopUpRefNo.jsp?VALENC="+val;
	 	 var width  = 920;
		 var height = 600;
...
{
	var url="GeneralReports_FileMovController?referenceIdenc="+val+"&reportNumber="+5;
	 	 var width  = 1024;
		 var height = 600;
		 var left   = (screen.width  - width)/2;
		 var top    = (screen.height - height)/2;
...
<table align="center" style="border: 0;border-color: transparent;"  cellpadding="0" cellspacing="0">  
	<tr>
		<td colspan='5' align="left" height="28"><label for="searchString">Please Enter at least two Character</label>
			<input type="text" name="searchString" id="searchString" size="60" align="left" tabindex="1"></td>
	...
	<tr>
		...
		<input type="text" size="15" name="FDATE" id="FDATE"  value='<c:out value = "<%=sessionBean.getTENURESTARTDATE() %>"/>' onblur="chkWorkDate(this);" onkeypress="chknumeric(47);" maxlength="10" tabindex="5">
		</td>
		<td align="left" colspan="1" style="vertical-align: top"><input type="text" size="15" name="TDATE" id="TDATE"  value='<c:out value = "<%=serverDate%>"/>' onblur="chkWorkDate(this);" onkeypress="chknumeric(47);" maxlength="10" tabindex="5">
		</td>
		<td align="right" >&nbsp;<input style="height: 20px; background-color:#f5f5f5" type="button" name="search" value="Search" onclick="getsearchDetail();" title="Search" tabindex="2"></td>
	</tr>
	<tr>
