...
if(window.document.frm.REP[i].checked==true)
  {
	...
	hideTR(document.getElementById("trsenton"));
	...
	unhideTR(document.getElementById("trsenton"));
	if(isconf == "1"){
	unhideTR(document.getElementById("trconf"));
	}
	if(isreply == "1"){
				...
				<div id="d2">
							<table width="100%" id="data">
								<tbody>
									...
									<td align="left" width="410"><input type="text" name="datefrom" id="datefrom" value="<c:out value='<%=sessionBean.getTENURESTARTDATE() %>'/>" size="11" tabindex="3"> to
									<input type="text" name="dateto" id="dateto" value="<c:out value='<%= serverDate %>'/>" size="11" tabindex="4"></td>
									</tr>
					...
					<tr id="trsenton"  style="display: none;">
					<td align="right" width="222">Sent On<font color="red"></font> :</td>
					<td align="left" width="410"><input type="text" name="markingdatefrom" id="markingdatefrom" value="" size="11" > to
					<input type="text" name="markingdateto" id="markingdateto" value="" size="11" ></td>
				</tr>
				<tr id="trconf">
