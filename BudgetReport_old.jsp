			...
			<tbody>
				<tr valign="top" align="left">
					...
					<td width="120"><input type="radio" style="height: 10px; width: 10px;"
						...
						id="REFNOFROM" name="REFNOFROM" size="12" value="<%=REFNOFROM %>"
					...
					<td width="277"><input type="text" id="REFNOTO" name="REFNOTO" size="12" tabindex="3"
						value="<%=REFNOTO %>" style="text-transform: uppercase;"
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 848px; border: solid 1px black;border-style: dotted"">
	<tr align="left">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="LETDATETO" tabindex="8"
			name="LETDATETO" size="12" value="<%=LETDATETO %>" /></td>
	...
	<tr align="left">
			...
			id="VIPSTATUS" value="<%= VIPSTATUS %>" size="35" /></td>
		...
		<select name="STATECODE" style="width: 120px" tabindex="11">
			...
			<option value="<%=beanCommon.getField1()%>"
				<%=STATECODE.equals(beanCommon.getField1())? "selected":"" %>><%=beanCommon.getField2()%></option>
			<%
														}%>
		</select></td>
												</tr>
			...
			<%
																		...
																		%>
			<option value="<%=beanCommon.getField1()%>"
				<%=SUBJECTCODE.equals(beanCommon.getField1())? "selected":"" %>><%=beanCommon.getField2()%></option>

			<%
																	}%>
		</select></td>
														<td width="107">Subject :</td><td colspan="3" width="376"><input type="text" name="SUBJECT" size="35" value="<%=SUBJECT%>" tabindex="13"/></td></tr>
												<tr align="left">
													<td width="93">MR's Remarks :</td><td width="270"><input tabindex="14"
			type="text" name="MRREMARK" size="35" value="<%=MRREMARK%>" /></td><td width="107">Remarks :</td><td colspan="3" width="376"><input tabindex="15"
			type="text" name="REMARK" size="35" value="<%=REMARK%>" /></td></tr>
	<tr align="left">
		<td width="93"><br />
		</td>
		<td width="270"></td>
	...
	<tr align="left">
										...
										<tr onclick="resetSrNo();">
										  ...
										  for (int i = 0; i < dataArr.size(); i++) {
												...
												attachment = (cmnbn.getField12().equalsIgnoreCase("1")? "<img border='0' alt='Image Gallery' src='images/stn.gif' onclick='popupGallery("+cmnbn.getField13()+","+cmnbn.getField13()+");'>": "");
										   %>
										   <tr >  
					    						<td><%=i+1%>.</td>
					    						<td><%=attachment%></td>
					    						<td><%=cmnbn.getField1()%></td>
					    						<td><%=cmnbn.getField2()%></td>
					    						<td><%=cmnbn.getField3()%></td>
					    						<td><%=cmnbn.getField4()%></td>
					    						<td><%=cmnbn.getField5()%></td>
					    						<td><%=cmnbn.getField6()%></td>
					    						<td><%=cmnbn.getField7()%></td>
					    						<td><%=cmnbn.getField8()%></td>
					    						<td><%=cmnbn.getField9()%></td>
					    						<td><%=cmnbn.getField10()%></td>
					    						<td><%=cmnbn.getField11()%></td>
										  </tr>
										  <%
										   }
										   %>
										 ...
										 <%
										   ...
										   %><br /><table><tr><td><font color="red"><%= msg %></font></td></tr></table><%} %>
  </form> 
</body>
</html>