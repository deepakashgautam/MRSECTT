...
ArrayList<CommonBean> RefDashBoardDetails = new CommonDAO().getRefDashBoardDetails(sessionBean.getLOGINASROLEID());
String statesOfRole = new DashboardSubjectWiseDAO().getStatesOfRole(sessionBean.getLOGINASROLEID());
...
<table width="100%" >
 	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="margin-top: 0px;margin: 0px;" >
			<tr>
				...
				<td id="SubHdCenTop" >
				<font size="4px">Subject wise breakup for <c:out value='<%= statesOfRole%>' /></font></td>
				<td >
    ...
    <input type ="hidden" value =<c:out value='<%= sessionBean.getLOGINASROLEID() %>' /> name ="loginid">	
    <input type ="hidden" value ="stateCoordinator" name ="typeOfUser">					
        <button class="btn btn-large btn-primary" type="submit">Print in Excel</button>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <a href="StateCoordinatorsDashboard.jsp" target='_blank'><b>State Wise Detailed Report<b></a>
      </form>
...
<!-- CHANGED ON 24_07_2012 -->
			<table width="100%" style="margin-top: 1px;margin: 1px;" border="1" hieght = '40%'  >
				...
				<tr>
				<td> <c:out value='<%=bn.getField8() %>' /></td>
				<td><a href="DetailedListOfDashboard.jsp?subjectCode=<c:out value='<%= bn.getField1() %>'/>&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='A'" target='_blank'><c:out value='<%=bn.getField2() %>'/></a></td>
				<td><a href="DetailedListOfDashboard.jsp?subjectCode=<c:out value='<%= bn.getField1() %>'/>&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='B'" target='_blank'><c:out value='<%=bn.getField3() %>'/></a></td>
				<td><a href="DetailedListOfDashboard.jsp?subjectCode=<c:out value='<%= bn.getField1() %>'/>&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='C'" target='_blank'><c:out value='<%=bn.getField4() %>' /></a></td>
				<td><a href="DetailedListOfDashboard.jsp?subjectCode=<c:out value='<%= bn.getField1() %>'/>&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='D'" target='_blank'><c:out value='<%=bn.getField5() %>' /></a></td>
				<td><a href="DetailedListOfDashboard.jsp?subjectCode=<c:out value='<%= bn.getField1() %>'/>&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='E'" target='_blank'><c:out value='<%=bn.getField6() %>'/></a></td>
				<td><b><a href="DetailedListOfDashboard.jsp?subjectCode=<c:out value='<%= bn.getField1() %>'/>&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status=Total" target='_blank'><c:out value='<%=bn.getField7() %>'/></a></b></td>
				</tr>
				<%} else {%>
			<tr>
			<td><b>Total</b></td>
			<td><b><a href="DetailedListOfDashboard.jsp?subjectCode=All&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='A'" target='_blank'><c:out value='<%=bn.getField2() %>'/></a></b></td>
			<td><b><a href="DetailedListOfDashboard.jsp?subjectCode=All&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='B'" target='_blank'><c:out value='<%=bn.getField3() %>'/></a></b></td>
				<td><b><a href="DetailedListOfDashboard.jsp?subjectCode=All&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='C'" target='_blank'><c:out value='<%=bn.getField4() %>'/></a></b></td>
				<td><b><a href="DetailedListOfDashboard.jsp?subjectCode=All&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='D'" target='_blank'><c:out value='<%=bn.getField5() %>'/></a></b></td>
				<td><b><a href="DetailedListOfDashboard.jsp?subjectCode=All&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status='E'" target='_blank'><c:out value='<%=bn.getField6() %>'/></a></b></td>
				<td><b><a href="DetailedListOfDashboard.jsp?subjectCode=All&loginID=<c:out value='<%= sessionBean.getLOGINASROLEID() %>'/>&status=Total" target='_blank'><c:out value='<%=bn.getField7() %>'/></a></b></td>
				</tr>
				<%}%>
				<%}%>
				</table>
