...
contentsource: ["smoothcontainer", "MENUAdmin.jsp"] //"markup" or ["container_id", "path_to_menu_file"]
});
...
{
	if(x=='home')
			document.getElementById("tmscontent").src="<%= request.getContextPath().toString() %>/Home.jsp";
	else if(x=='logoff')
