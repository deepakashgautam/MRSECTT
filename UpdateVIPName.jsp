...
<%
	...
	condition+=" and tenureid in ('11','12','13','14','15','16','17','18') ";
...
$(document).ready(function(){
   ...
   $("input[name='NEWNAME']").result(function(event, data, formatted) {
		   ...
		   // alert(data);
			...
			//new code
			document.getElementsByName('VIPID')[idx].value = dataarr[4];
			document.getElementsByName('VIPADDRESS')[idx].value = dataarr[5];
		}
	});
  });
</script>
...
<FORM action="UpdateVIPName.jsp" method="post"  name="frmUpdateRole">
<table width="100%">
<tr>
	<td><font size="3" > 
	...
	<TBODY>
		<tr class="treven">
			<td valign="top" align="center" width="46"><input type="text" id="REFERENCENAME" name="REFERENCENAME"
								maxlength="50" value="<c:out value='<%= REFERENCENAME %>'/>"
			...
			<td valign="top" align="center" width="72"><input type="text"
								...
								value="<c:out value='<%=  VIPSTATUS%>'/>" size="45" onkeypress="allowAlphaNum('()/');"></td>
			<td valign="top" align="center" width="119"><input type="text" name="STATECODE" id="STATECODE" value="<c:out value='<%=  STATECODE%>'/>"></td>
			<td valign="top" align="center" width="119"><input type="text" name="VIPPARTY" id="VIPPARTY" value="<c:out value='<%=  VIPPARTY%>'/>"></td>
...
<TABLE align="center" width="80%">
	<TBODY>
		<tr class="treven">
			...
			<td valign="top" align="center" width="118">New VIPID</td>
			<td valign="top" align="center" width="119">New VIPTYPE</td>
		</tr>
	</TBODY>
	<TBODY id="baserow">
<%
...
%>
		<TR class="<%=i%2==0?"treven":"trodd" %>" align="left" >
			...
			<td><input type="text" name="OLDNAME" id="OLDNAME"  value="<c:out value='<%= beanCmn.getField1()%>'/>" maxlength="4" readonly size="30" ></td>
			<td><input type="text" name="OLDSTATUS" id="OLDSTATUS" maxlength="50" value="<c:out value='<%= beanCmn.getField2()%>'/>" size="30" readonly><INPUT type="hidden" name="dtlid" value="<%=bean.getField1()%>"></td>
			<td><input type="text" name="OLDSTATE" id="OLDSTATE" maxlength="50" value="<c:out value='<%= beanCmn.getField3()%>'/>" size="5" ></td>
			<td><input type="text" name="OLDPARTY" id="OLDPARTY" maxlength="50" value="<c:out value='<%= beanCmn.getField4()%>'/>" size="5" ></td>
			...
			<td><input type="text" name="VIPID" id="VIPID" value="" size="30">
			<td><input type="text" name="VIPADDRESS" id="VIPADDRESS" value="" size="30">
