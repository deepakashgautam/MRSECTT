...
function bodyOnload(){
	...
	setSessionSeachParams('sVIPID', '<%=sBean.getField1()%>');
	setSessionSeachParams('sVIPNAME', '<%=sBean.getField2()%>');
	setSessionSeachParams('sSTATECODE', '<%=sBean.getField3()%>');
	setSessionSeachParams('sVIPSTATUS', '<%=sBean.getField3()%>');
	setSessionSeachParams('sVIPCONSTITUENCY', '<%=sBean.getField3()%>');
	setSessionSeachParams('sVIPPARTY', '<%=sBean.getField3()%>');
			...
			<div >
			    <div >
					...
					<tr class="trodd">
						...
						<input type="text" name="VIPID" class="readonly" value="<%=mstVIPBean.getVIPID()%>" onkeypress="chknumeric();" maxlength="3" readonly="readonly"><font color="green">Last VIP ID : <%=beanCmn.getField1()%></font></td>
					...
					<tr class="trodd">
						...
						<td height="31" valign="middle" width="271"><input
							...
							value="<%=mstVIPBean.getVIPNAME() %>" size="50"></td>
					</tr>
					<tr class="trodd">
...
<td height="31" valign="middle" width="271">
						...
						%>
							<option value="<%=beanStateCode.getField1()%>" <%=beanStateCode.getField1().equalsIgnoreCase(mstVIPBean.getSTATECODE())?"selected":""%>><%=beanStateCode.getField2()%></option>
						<%}%>
				</select>
						</td>
					</tr>
...
<td height="31" valign="middle" width="271">
						...
						%>
							<option value="<%=beanparty.getField1()%>" <%=beanparty.getField1().equalsIgnoreCase(mstVIPBean.getPARTYCODE())?"selected":""%>><%=beanparty.getField2()%></option>
						<%}%>
				</select>
						</td>
					</tr>
					<tr class="trodd">
						...
						<td height="31" valign="middle" width="271"><input type="text"
							...
							value="<%=mstVIPBean.getVIPSTATUS() %>" size="20"></td>
					</tr>
					<tr class="trodd">
						<td nowrap height="31" valign="middle" width="170">VIP Constituency</td>
						<td height="31" valign="middle" width="271"><input type="text" id="VIPCONSTITUENCY"
							name="VIPCONSTITUENCY" maxlength="20"  
							value="<%=mstVIPBean.getVIPCONSTITUENCY() %>" size="20"></td>
					</tr>
					<tr class="trodd">
						...
						<td height="31" valign="middle" width="271"><input type="text" id="VIPPARTY"
							...
							value="<%=mstVIPBean.getVIPPARTY() %>" size="20"></td>
					</tr>
					<tr class="trodd">
						...
						<td height="31" valign="middle" width="271"><input type="text" id="VIPADDRESS"
							...
							value="<%=mstVIPBean.getVIPADDRESS() %>" size="20"></td>
					</tr>
					<tr class="trodd">
						...
						<td height="31" valign="middle" width="271"><input type="text" id="MOBILENO"
							...
							value="<%=mstVIPBean.getMOBILENO() %>" size="20"></td>
					</tr>
