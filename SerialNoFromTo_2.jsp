...
function popupGallery(refId, flg)
{
	...
	var url="ImageGallery.jsp?refId1="+refId+"&flgnoenc="+flg+"&type=F";
...
<table width="100%" border="0" cellspacing="0" align="center" style="font-family: Tahoma; font-size: 10">
		...
		<tr>
		<td align="left">
			<b>File(s) received in Sectt., related to <c:out value='<%= markTo%>'/>, <c:out value='<%= fStatus1%>'/>, <c:out value='<%= fStatus2%>'/><%= fileType.length()>0? fileType.equalsIgnoreCase("A")? ", Approval": fileType.equalsIgnoreCase("D")? ", Draft": fileType.equalsIgnoreCase("P")? ", Position": fileType.equalsIgnoreCase("C")? ", Conf.":"" : "" %></b><br>
...
<table width="100%" cellspacing="0" cellpadding="0" style="font-family: Tahoma; font-size: 10px;">
	<thead style="display: table-header-group;">
		...
		%>
		<tr valign="top">
		   <td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><c:out value='<%=(i+1)%>'/>.&nbsp;<br><%=bean.getField23().equalsIgnoreCase("1")?bean.getField24():"" %></td>
		<% if(bean.getField20().equalsIgnoreCase("C")){ %>
		   <td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><font color="red"><c:out value='<%=bean.getField2()%>'/>*</font><br><c:out value='<%=bean.getField3()%>'/>&nbsp;<br><c:out value='<%=bean.getField22()%>'/></td>
		<%}else{ %>
		   <td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><c:out value='<%=bean.getField2()%>'/><br><c:out value='<%=bean.getField3()%>'/>&nbsp;<br><c:out value='<%=bean.getField22()%>'/></td>
		<%} %>
		   <td align="center" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><c:out value='<%=bean.getField4()%>'/>&nbsp;</td>
		   <td align="left" style="border-bottom: dotted; border-width: 1px; border-color: gray;" valign="top"><c:out value='<%=bean.getField5()%>'/><br>
		   <%
