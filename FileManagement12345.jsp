...
<%
				...
				<tbody>
			    	...
			    	<tr class="trodd">
							...
							<td id="tdn" style="display: none"><div id="tdNOL" style="display: none;"><input type="text" name="NOL" id="NOL" size="2" maxlength="3" value="<%= fileBean.getNOL().length()>0? fileBean.getNOL():1 %>" tabindex="19"></div></td>
