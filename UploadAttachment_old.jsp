      		...
      		Attachment</b></font><img src="${pageContext.request.contextPath}/images/arrow_big.gif" width="6" height="11">    
				...
				<table width="100%" id="data" align="center">
								<tbody>
									...
									<input type="text" name="diarynoto" id="diarynoto" size="15" value="<%= diarynoto %>" style="text-transform: uppercase;"> (e.g. A/1)
									...
									<td align="left" width="784"><input type="text" name="datefrom" id="datefrom" value="<%=sessionBean.getTENURESTARTDATE() %>" size="11"> to
