				...
				<td align="center"><table width="984px" border="0"  cellspacing="0"
					...
					<tr>
						...
						<br><br><center><fieldset style="width: 50%;">		
								...
								<input type="text" name="FBOOKDATE" id="FBOOKDATE" value="<c:out value='<%=request.getParameter("FBOOKDATE")!=null ? request.getParameter("FBOOKDATE"):serverDate%>'/>" size="10"/>
								 <b>TO </b><input type="text" name="TBOOKDATE" id="TBOOKDATE" value="<c:out value='<%=request.getParameter("TBOOKDATE")!=null ? request.getParameter("TBOOKDATE"):serverDate%>'/>" size="10"/>
						...
						<table width="80%" class="tablesorter" id="sorttable" align="center">
								...
								<tr>
									<th colspan="4" style="font-style: normal; font-weight: 500; line-height: normal; text-align: center"><c:out value='<%= sessionBean.getTENUREOFFICEADDRESS() %>'/></th>
								</tr>
						</table>
						<table width="80%" class="tablesorter" id="sorttable" align="center">
							<thead style="display: table-header-group;">
								<tr>
									<td nowrap="nowrap" style="text-align: left;" width="442"> <HR> OUT DAK FOR DT : <c:out value='<%=request.getParameter("FBOOKDATE")!=null ? request.getParameter("FBOOKDATE"):"" %>'/>  &nbsp;TO <c:out value='<%=request.getParameter("TBOOKDATE")!=null ? request.getParameter("TBOOKDATE"):"" %>'/><br/>Ref.Class : <c:out value='<%=request.getParameter("CLASS").length()>0 ? request.getParameter("CLASS"): "ALL" %>'/><HR></td>
